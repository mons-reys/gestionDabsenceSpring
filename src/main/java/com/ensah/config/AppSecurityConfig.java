...
public class AppSecurityConfig extends WebSecurityConfigurerAdapter { // Il faut hériter de WebSecurityConfigurerAdapter
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers("/Etudiant/**").hasRole("Etudiant")  //Le role USER accèdent aux requete commençant par /user/
        ...
        .antMatchers("/Enseignant /**").hasRole("Enseignant")
            .antMatchers("/Cadre-Administrateur/**").hasRole("CADRE")
